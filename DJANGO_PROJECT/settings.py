...
from mondoir.install import get_mondoir_app_list_install, get_mondoir_middleware_list
...
REST_FRAMEWORK = {
  ...
  'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.LimitOffsetPagination',
    ...
    #     'mondoir.utilities.throttling.BurstRateThrottle',
    #     'mondoir.utilities.throttling.SustainedRateThrottle',
    # ],
}
