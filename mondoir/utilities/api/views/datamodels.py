...
from mondoir.utilities.permissions import AllowOwner, AllowStaff
from mondoir.utilities.api.filters import FilterBackend
...
class DataModelViewSet(ModelViewSet):
    ...
    def admin(self, request):
        queryset = self.filter_queryset(self.get_queryset_admin(request))
